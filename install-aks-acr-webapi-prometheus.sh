...
sed 's/<ContainerName>/'$containerName'/g' ./TestFunctionPrometheusAppv3.1/webapideployment.yaml > local_webapi_A.yaml 
sed -i 's/<FunctionName>/'$functionAName'/g' local_webapi_A.yaml 
sed -i 's/<ACRName>/'$acrName'/g' local_webapi_A.yaml
sed -i 's/<ACRSecret>/'$acrPassword'/g' local_webapi_A.yaml
kubectl apply -f local_webapi_A.yaml

WriteLog "Deploying WebAPI Net Core 3.1 container hosting the function B" 
sed 's/<ContainerName>/'$containerName'/g' ./TestFunctionPrometheusAppv3.1/webapideployment.yaml > local_webapi_B.yaml 
sed -i 's/<FunctionName>/'$functionBName'/g' local_webapi_B.yaml 
sed -i 's/<ACRName>/'$acrName'/g' local_webapi_B.yaml
sed -i 's/<ACRSecret>/'$acrPassword'/g' local_webapi_B.yaml
kubectl apply -f local_webapi_B.yaml

WriteLog "Deploying an Ingress resource pointing to the function A" 
sed 's/<FunctionName>/'$functionAName'/g' ./TestFunctionPrometheusAppv3.1/testfunctionapp.yaml > local_func_A.yaml
sed -i 's/<AKSDnsName>/'$PublicDNSName'/g' local_func_A.yaml
kubectl apply -f local_func_A.yaml

WriteLog "Deploying an Ingress resource pointing to the function B" 
sed 's/<FunctionName>/'$functionBName'/g' ./TestFunctionPrometheusAppv3.1/testfunctionapp.yaml > local_func_B.yaml
sed -i 's/<AKSDnsName>/'$PublicDNSName'/g' local_func_B.yaml
...
WriteLog "Deploying an Ingress resource pointing to the function A" 
sed 's/<FunctionName>/'$functionAName'/g' ./TestFunctionPrometheusAppv3.1/keda-prometheus.yaml > local_keda_A.yaml
kubectl apply -f local_keda_A.yaml

WriteLog "Deploying an Ingress resource pointing to the function B" 
sed 's/<FunctionName>/'$functionBName'/g' ./TestFunctionPrometheusAppv3.1/keda-prometheus.yaml > local_keda_B.yaml
